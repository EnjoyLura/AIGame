...
2. **功能入口图标**：已有 ico_mail/notice/setting/task/rank + shop_gift/chest/letter ✅；
   在库待接 ico_trophy/ico_lock/ico_achieve/shop_scroll 📦；
   待生图：加号、签到、图鉴、试炼、无尽、核心、武器、技能、升星、天赋、招募、锻造、广告▶、详情›、
...
5. **按钮**：六色语义板 5 色已接 ✅（紫板 ✗）；小圆钮 close/round ✅、round2 📦、home/help/refresh ✗。
...
7. **框·徽·角标**：品质框 frame_q0-q3 ✅（本轮接 `.popQ .qi`）；头像框 📦（接法见 §9 表）；
   段位徽章 rank1-7 📦（当前无段位 UI，待开功能）；等级角标/免费/折扣/HOT/战力徽章 ✗。
