 ...
 * - 加成全队生效、数值较小；攻击/据点耐久走 beginRun 乘区链，
...
export const BOND_DEFS: BondDef[] = [
    {
        id: 'bond_cockpit', name: '猎手搭档', members: ['rifle', 'sniper'], starNeed: 2, ic: '🤝',
        desc: '全队暴击率 +4%', effect: { crit: 0.04 },
    },
    {
        id: 'bond_spectrum', name: '奥术共鸣', members: ['laser', 'radiation'], starNeed: 2, ic: '🌈',
        desc: '全队攻击 +6%', effect: { atk: 0.06 },
    },
    {
        id: 'bond_overload', name: '元素过载', members: ['rifle', 'laser'], starNeed: 3, ic: '⚡',
        desc: '全队射速 +6%', effect: { rate: 0.06 },
    },
    {
        id: 'bond_crossfire', name: '齐射阵线', members: ['sniper', 'radiation'], starNeed: 3, ic: '🎯',
        desc: '全队射程 +8%', effect: { range: 0.08 },
    },
    {
        id: 'bond_ark', name: '王国军团', members: ['rifle', 'sniper', 'laser', 'radiation'], starSumNeed: 16, ic: '🛸',
        desc: '据点耐久 +15% 且全队攻击 +8%', effect: { vehHp: 0.15, atk: 0.08 },
    },
];
